...
| [Data (CSV)](https://raffaeleciccone-analyst.github.io/premier-league-index/premier_league_tpi_2026-27.csv) | Every qualified player, every column the engine writes, refreshed on every run |
